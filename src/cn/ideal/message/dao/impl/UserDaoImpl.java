...
public class UserDaoImpl implements UserDao {
    ...
    public void save(User user) {
        String sql = "INSERT INTO user_info(username,password,nickname,email,telephone,gender,birthday,status,code) VALUES (?,?,?,?,?,?,?,?,?)";
    ...
    public void update(User user) {
        String sql = "UPDATE user_info SET username = ?, nickname = ?, email = ?, telephone = ?, gender = ?, birthday = ? WHERE uid = ?";
        template.update(sql,user.getUsername(),user.getNickname(),user.getEmail(),user.getTelephone(),user.getGender(),user.getBirthday(),user.getUid());
    }
}
